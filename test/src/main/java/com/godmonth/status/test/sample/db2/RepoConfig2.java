...
//@EnableJpaRepositories(entityManagerFactoryRef = "e2", transactionManagerRef = "t2")
public class RepoConfig2 {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(
        ...
        return builder.dataSource(userDataSource).properties(properties).packages("com.uaepay.software.mgmt.domain").build();
    }
