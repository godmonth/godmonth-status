...
public class SampleOrderExecutorConfig3 {
    ...
    @Bean
    public StatusTransitor<SampleStatus, SampleTrigger> sampleStatusTransitor(@Value("classpath:/sample-status.json") Resource configResource, @Qualifier("sampleStateMachineAnalysis") AnnotationStateMachineAnalysis annotationStateMachineAnalysis) throws IOException {
